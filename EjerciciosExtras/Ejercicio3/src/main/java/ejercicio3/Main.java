 ...
 *  ecuación de 2° grado. Tendremos los 3 coeficientes como atributos, llamémosles a, b y c.
...
import ejercicio3.entidades.Cuadratica;

public class Main {

    public static void main(String[] args) {
        Cuadratica ecCuadratica = new Cuadratica(-2, -3 , 1);
        
        ecCuadratica.calcular();
    }
}
